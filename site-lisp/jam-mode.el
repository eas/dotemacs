...
;; From https://yisp.googlecode.com/svn/third-party/jam-mode.el
  ...
  (list
   ...
   (generic-make-keywords-list
     (list "actions" "bind" "case" "default" "else" "existing" "for" "if"
               "ignore" "in" "include" "local" "on" "piecemeal" "quietly"
               "rule" "switch" "together" "updated"
               ;; the following added by duzy
               "return" "while" "module" "class")
   ...
   (generic-make-keywords-list
     (list
        "ALWAYS" "DEPENDS" "ECHO" "INCLUDES" "LEAVES" "LOCATE" "NOCARE"
          ...
          ;; the follow added by duzy
          "GLOB" "MATCH" "FAIL_EXPECTED" "RMOLD")
